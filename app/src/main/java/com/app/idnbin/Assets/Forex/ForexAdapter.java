...
public class ForexAdapter extends RecyclerView.Adapter<ForexAdapter.MyViewHolder> {
    private Context context;
    private ArrayList<SymbolsData> symbolsDataList;
    private ArrayList<SymbolsData> symbolsDataArrayList = new ArrayList<>();
    private SQLiteDatabaseHandler db;

    ForexAdapter(Context context, ArrayList<SymbolsData> symbolsDataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.LL_Header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                db.addSymbol(symbolsDataList.get(position),"FOREX");
